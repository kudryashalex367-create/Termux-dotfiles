...
Все скачанные файлы сохраняются в глобальную системную память Android (`/sdcard/Download/`) и автоматически регистрируются через `termux-media-scan`, благодаря чему они мгновенно появляются в Галерее, Музыкальном плеере и VLC без перезагрузки телефона!
